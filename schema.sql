...
CREATE TABLE IF NOT EXISTS event_fixture_enrichment_state (
    ...
    player_stats_polled_at DATETIME NULL,
    last_player_stats_http_code INT NULL,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ...
    KEY idx_event_fixture_enrichment_player_stats (player_stats_polled_at, last_player_stats_http_code),
...
CREATE TABLE IF NOT EXISTS player_match_stats (
    ...
    shots_total SMALLINT NULL,
    shots_on_target SMALLINT NULL,
    goals_scored SMALLINT NULL,
    goals_conceded SMALLINT NULL,
    assists SMALLINT NULL,
    saves SMALLINT NULL,
    passes_total SMALLINT NULL,
    key_passes SMALLINT NULL,
    pass_accuracy SMALLINT NULL,
    tackles_total SMALLINT NULL,
    blocks SMALLINT NULL,
    interceptions SMALLINT NULL,
    duels_total SMALLINT NULL,
    duels_won SMALLINT NULL,
    dribbles_attempted SMALLINT NULL,
    dribbles_success SMALLINT NULL,
    fouls_drawn SMALLINT NULL,
    fouls_committed SMALLINT NULL,
    yellow_cards SMALLINT NULL,
    red_cards SMALLINT NULL,
    offsides SMALLINT NULL,
    penalty_won SMALLINT NULL,
    penalty_committed SMALLINT NULL,
    penalty_scored SMALLINT NULL,
    penalty_missed SMALLINT NULL,
    penalty_saved SMALLINT NULL,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (provider_fixture_id, provider_player_id),
    KEY idx_pms_player (provider_player_id),
    KEY idx_pms_team (provider_team_id),
    CONSTRAINT fk_pms_fixture FOREIGN KEY (provider_fixture_id) REFERENCES event_fixture(provider_fixture_id),
    CONSTRAINT fk_pms_player FOREIGN KEY (provider_player_id) REFERENCES player_dim(provider_player_id)
