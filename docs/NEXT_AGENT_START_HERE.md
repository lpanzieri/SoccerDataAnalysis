...
## Then do this
1. Validate schema with [setup_schema.py](/home/lpanzieri/Data-Analysis/setup_schema.py).
...
- [scripts/web/agent_api_server.py](/home/lpanzieri/Data-Analysis/scripts/web/agent_api_server.py)
- [docs/EXTERNAL_AGENT_INTEGRATION.md](/home/lpanzieri/Data-Analysis/docs/EXTERNAL_AGENT_INTEGRATION.md)
- [docs/examples/frontend_question_client.html](/home/lpanzieri/Data-Analysis/docs/examples/frontend_question_client.html)
