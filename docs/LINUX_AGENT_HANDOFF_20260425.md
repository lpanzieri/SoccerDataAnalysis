...
**Recent Optimization Merges:**
- Task 10 (Sync Batching): ✅ Merged to main. Batched writes reduce cursor churn in `sync_api_football_events.py`
- Task 11 (Adaptive Throttle): ✅ Merged to main. Header-aware pacing replaces fixed sleep; has CLI override flags
- See `OPTIMIZATION_EXECUTION_CHECKLIST.md` for full details and rollback instructions
